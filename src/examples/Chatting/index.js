  ...
  return (
    <ChattingRoot variant="permanent" ownerState={{ openChatting }}>
      ...
      >
        {user?.result ? (
          <MDBox>
            <MDTypography variant="h5" color="dark.main">Welcome to IOT Dashboard</MDTypography>
            <MDTypography variant="subtitle2" color="dark.main">
              The greenhouse supervising app.
            </MDTypography>
          </MDBox>
        ) : (
          <MDBox>
            <MDTypography variant="h5" color="dark.main">Have you sign in yet?</MDTypography>
            <MDTypography variant="body2" color="dark.main">
              Sign in below.
            </MDTypography>
          </MDBox>
        )}
